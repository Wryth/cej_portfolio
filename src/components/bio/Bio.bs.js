...
function Bio$Bio(Props) {
  ...
  return React.createElement("div", {
              id: "bioContainer"
                      ...
                      className: "bioText largeText"
                    }, "Inspired by the dictum of late Danish sculptor Willy Ørskov's theory that \"the content of the sculpture  is sculpture\", his nonfigurative sculp" + String.fromCharCode(968), "tures exist  on their own terms as abstract, physical forms fostering experiential connection over intellectual interference in the elastic borderland between nature and culture."), React.createElement("p", {
                      className: "bioText textEnd largeText"
                    }, "Carl Emil Jacobsen is represented by Galerie Maria Wettergren in Paris and has been exhibited at Art Basel, PAD, Clay Museum of Ceramic Art Denmark, Mindcraft Exhibition in Milan, Patrick Parrish Gallery, Chamber Gallery, Kunsthal Charlottenborg, Piscine and elsewhere.")), React.createElement(React.Fragment, undefined, React.createElement("div", {
                      className: "bioHeader largeText"
                    }, React.createElement("p", {
                          className: "bioHeader largeText"
